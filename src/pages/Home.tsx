...
export default function Home() {
  return (
    <div className="bg-primary flex flex-col items-center gap-8 p-10 text-center md:flex-row-reverse md:justify-between md:text-left md:text-xl md:items-center md:my-12 md:px-4">
